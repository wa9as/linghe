...
def test_silu_and_block_quant(M=4096, N=4096, bench=False):
    ...
    y_q_ref, y_scale_ref, _, yt_q_ref, yt_scale_ref = torch_silu_and_block_quant_forward(
        x)
...
if __name__ == '__main__':
    ...
    test_triton_batch_weighted_silu_and_block_quant(M=4096, N=2048,
                                                    n_experts=32, bench=True)
    test_triton_batch_weighted_silu_and_block_quant(M=1008, N=2048,
