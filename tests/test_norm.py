...
def test_rmsnorm(M=4096, N=4096):
    ...
    q, scale, maxs, rms = triton_rms_norm_and_quant_forward(x,weight,smooth_scale,round_scale=True)
    q_ref, scale_ref =  torch_smooth_quant(y_ref,smooth_scale,reverse=False,round_scale=True)
