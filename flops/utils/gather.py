...
@triton.jit
def permute_with_mask_map_kernel(grads_data_ptr, grads_scale_ptr, probs_ptr,
                                 mask_map_ptr, quant_data_ptr, quant_scale_ptr,
                                 output_probs_ptr, num_experts: tl.constexpr,
